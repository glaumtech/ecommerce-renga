...
echo "  curl -sI https://rengaa.in/robots.txt | grep -i content-type"
echo "  curl -sI https://rengaa.in/sitemap.xml | grep -i content-type"
echo "  (expect text/plain or application/xml, not text/html)"
echo ""
echo "Google Search Console:"
echo "  1. Verify property https://rengaa.in (meta tag in Store SEO)"
echo "  2. Submit sitemap: https://rengaa.in/sitemap.xml"
echo "  3. URL Inspection: sample product + /shop/brassware"
echo "  4. Rich Results Test: https://search.google.com/test/rich-results"
